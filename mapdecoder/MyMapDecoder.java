...
public class MyMapDecoder implements MapDecoder {
    ...
    /*
    Implement a method that decodes a String to a corresponding Map. The String is composed of key-value pairs. Key is separated from value
     with an 'equals' character ('='). Pairs are separated with an 'ampersand' character ('&'). Example: key=value&key=value&....
